...
export class ButtonComponent {
  ...
  readonly cls = computed(() => {
    const base = 'inline-flex items-center gap-1.5 font-medium focus:outline-none focus:ring-2 focus:ring-offset-1 transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed';
